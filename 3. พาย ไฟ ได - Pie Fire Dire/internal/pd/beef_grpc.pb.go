...
const (
	BeefService_FindBeef_FullMethodName = "/pb.BeefService/FindBeef"
)
...
type BeefServiceClient interface {
	FindBeef(ctx context.Context, in *FindBeefRequest, opts ...grpc.CallOption) (*FindBeefResponse, error)
}
...
func (c *beefServiceClient) FindBeef(ctx context.Context, in *FindBeefRequest, opts ...grpc.CallOption) (*FindBeefResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FindBeefResponse)
	err := c.cc.Invoke(ctx, BeefService_FindBeef_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BeefServiceServer interface {
	FindBeef(context.Context, *FindBeefRequest) (*FindBeefResponse, error)
...
func (UnimplementedBeefServiceServer) FindBeef(context.Context, *FindBeefRequest) (*FindBeefResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindBeef not implemented")
}
...
func _BeefService_FindBeef_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindBeefRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BeefServiceServer).FindBeef(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BeefService_FindBeef_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeefServiceServer).FindBeef(ctx, req.(*FindBeefRequest))
	}
...
var BeefService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.BeefService",
	HandlerType: (*BeefServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FindBeef",
			Handler:    _BeefService_FindBeef_Handler,
		},
	},
